...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    expect(queryByText(appointment, /save/i)).toBeInTheDocument();

    fireEvent.click(queryByText(appointment, /save/i));

    expect(getByText(appointment, "Saving")).toBeInTheDocument();

    await waitForElement(() => getByAltText(appointment, /delete/i));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    fireEvent.click(queryByAltText(appointment, /close/i));
  ...
  it("shows the delete error when failing to delete an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, /There was an error while deleting/i));
